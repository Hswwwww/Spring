...
//		
//		//   /add.do?seq=10&mode=del >> 리다이렉트를 쓸떄 쿼리스트링으로 값을 넘긴다.!
...
//	}
	...
	//@ResponseBody 사용하면 다 JSON처리로 해줌!!
...
//		dto.setAddress("서울시");
//		
//		return dto; // {"name":"홍길동","age":20,"address":"서울시"}
//		
//		
//	}
...
//		
//		return  list; //["홍길동","아무개","하하하","호호호","후후후"]
//	
//		
//	}
	...
	public @ResponseBody List<AddressDTO> ex08(){
		...
		return list; //[{"name":"홍길동","age":20,"address":"서울시"},{"name":"아무개","age":20,"address":"부산시"}]
