...
public class AOPController {
	...
	public String test() {         
		...
		//BooardDTO b1 = new BoardDTO();
		BoardDTO b1 = new BoardDTO.BoardDTOBuilder() // 자유롭게 object를 만들 수 있음.
							.setSeq("1")
							.setSubject("제목입니다.")
							.setContent("내용입니다.")
							.setName("홍길동")
...
//		
//		System.out.println(dao3.service());
//		
...
//		dto2.setName("아무개");
//		
//		System.out.println(dto1==dto2); 	   //false > 주소값 비교
